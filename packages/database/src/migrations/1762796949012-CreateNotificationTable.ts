...
export class CreateNotificationTable implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createForeignKey(
      'notifications',
      new TableForeignKey({
        name: 'fk_notifications_meeting_id',
    ...
    await queryRunner.createIndex(
      'notifications',
      new TableIndex({
        name: 'idx_notifications_meeting_id',
        columnNames: ['meeting_id'],
      })
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropIndex('notifications', 'idx_notifications_meeting_id');
    await queryRunner.dropIndex('notifications', 'idx_notifications_user_id');
    await queryRunner.dropForeignKey('notifications', 'fk_notifications_meeting_id');
